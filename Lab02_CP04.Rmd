...
01) Retirar os registros onde o local do primeiro click (first_click) é maior que a quantidade de resultados da busca (results). Ou seja, um comportamento que não deveria acontecer. 
...
02) Retirar os registros onde houveram clicks (num_clicks > 0), mas não existe registro do primeiro click (first_click). Ou seja, um comportamento que não deveria acontecer. 
...
03) Vamos também formatar a coluna referente a data da busca
